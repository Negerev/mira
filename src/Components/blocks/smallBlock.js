...
const SmallBlock = ({ process, image1, imageMin1, alt1, classes1, description1, pageName1, caseName1, image2, imageMin2, alt2, classes2, description2, pageName2, caseName2, onSelectCase }) => {
...
const CasesShellSmall = () => {
        return (
            <div className="cases__shell cases__shell--small fade-in">
        <div className="cases__container small-container">
        ...
        <p className="cases__description cases__description--small">{description1}</p>
      </div>
    );
  };
  ...
  const CasesShellBig = () => {
    return (
      <div className="cases__shell cases__shell--big fade-in">
        <div className="cases__container semi-container">
        ...
        <p className="cases__description">{description2}</p>
      </div>
    );
  };

  const onRenderSmall = image1 ?  <CasesShellSmall  /> : null;
  
  return (
    <div className="cases__wrap" ref={container}>
        { onRenderSmall }
